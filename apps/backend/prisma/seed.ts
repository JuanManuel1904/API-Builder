...
async function main() {
  ...
  const demoMetadata = {
    entities: [
      {
        ...
        fields: [
          ...
          { id: 'f002', name: 'email', type: 'string', constraints: { required: true, unique: true } },
          { id: 'f003', name: 'name', type: 'string', constraints: { required: true } },
          { id: 'f004', name: 'role', type: 'enum', constraints: { enumValues: ['admin', 'user'], default: 'user' } },
    ...
    flows: [],
    endpoints: [
      { id: 'ep001', method: 'GET', path: '/users', tags: ['user'], isPublic: false, summary: 'List users' },
      { id: 'ep002', method: 'POST', path: '/users', tags: ['user'], isPublic: true, summary: 'Create user' },
      { id: 'ep003', method: 'GET', path: '/users/:id', tags: ['user'], isPublic: false, summary: 'Get user' },
      { id: 'ep004', method: 'PUT', path: '/users/:id', tags: ['user'], isPublic: false, summary: 'Update user' },
      { id: 'ep005', method: 'DELETE', path: '/users/:id', tags: ['user'], isPublic: false, summary: 'Delete user' },
      { id: 'ep006', method: 'GET', path: '/products', tags: ['product'], isPublic: true, summary: 'List products' },
      { id: 'ep007', method: 'POST', path: '/products', tags: ['product'], isPublic: false, summary: 'Create product' },
    ],
    validations: [],
